...
function displayContrast() {
  ...
  let val1 = contrastRatio(
    getComputedStyle(document.documentElement).getPropertyValue("--pantoned6"),
    getComputedStyle(document.documentElement).getPropertyValue("--pantoned1")
  );
  let val2 = contrastRatio(
    getComputedStyle(document.documentElement).getPropertyValue("--pantoned5"),
    getComputedStyle(document.documentElement).getPropertyValue("--pantoned2")
  );
  let val3 = contrastRatio(
    getComputedStyle(document.documentElement).getPropertyValue("--pantoned3"),
    getComputedStyle(document.documentElement).getPropertyValue("--pantoned6")
  );
  ...
  for (let i = 1; i < children.length; i += 2) {
    if (i < 12) {
      ...
      children[i].addEventListener("mouseenter", (event) => {
        event.target.textContent = RGBToHex(
